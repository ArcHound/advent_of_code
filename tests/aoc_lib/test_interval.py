    ...
    cases = [
        {
            "label": "middle",
            "input": {
                "list_a": [Interval(0, 10)],
                "list_b": [Interval(0, 0), Interval(1, 6), Interval(7, 10)],
            },
        ...
        },
        {
            ...
            "input": {
                "list_a": [Interval(0, 10)],
                "list_b": [Interval(0, 6), Interval(7, 10)],
            },
        ...
        },
        {
            ...
            "input": {
                "list_a": [Interval(0, 10)],
                "list_b": [Interval(0, 2), Interval(3, 10)],
            },
        ...
        },
        {
            "label": "intersection",
            "input": {
                "list_a": [Interval(0, 10), Interval(11, 16)],
                "list_b": [Interval(0, 7), Interval(8, 12), Interval(13, 16)],
            },
            "output": [
                Interval(0, 7),
                Interval(8, 10),
    ...
    cases = [
        {
            "label": "simple",
            "input": {
                "list_a": [Interval(0, 0), Interval(1, 6), Interval(7, 10)],
                "mask": [Interval(1, 6, "good")],
            },
        ...
        },
        {
            ...
            "input": {
                ...
                "mask": [Interval(0, 7, "good"), Interval(11, 12, "good")],
            },
            "output": [
                Interval(0, 7, "good"),
                Interval(8, 10, "bad"),
...
def test_fill_holes():
    cases = [
        ...
        },
        {
            "label": "two holes",
            "input": {
                "list_a": [Interval(0, 7), Interval(11, 12), Interval(15, 16)],
                "label": "good",
            },
            "output": [
                Interval(0, 7),
