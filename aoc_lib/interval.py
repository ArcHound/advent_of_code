...
class Interval:
    ...
    def overlap_other(self, other: Interval) -> bool:
        return (self.contains(other) or other.contains(self) or (self.start>other.start and self.start>other.end) or (self.end>other.start and self.end<other.end))

    @classmethod
    def overlap(cls, a: Interval, b: Interval) -> bool:
        return (a.contains(b) or b.contains(a) or (a.start>b.start and a.start<b.end) or (a.end>b.start and a.end<b.end))

    @classmethod
    def least_common_intervals(cls, list_a:list[Interval], list_b:list[Interval])-> list[Interval]:
