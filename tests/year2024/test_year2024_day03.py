...
from aoc.year2024.day03 import part1, part2
    ...
    cases = [
        {
            "label": "small",
            "input": {
                "in_data": """xmul(2,4)%&mul[3,7]!@^do_not_mul(5,5)+mul(32,64]then(mul(11,8)mul(8,5))
"""
            },
            "output": "161",
            "ex": None,
    ...
    cases = [
        {
            "label": "small",
            "input": {
                "in_data": """xmul(2,4)&mul[3,7]!^don't()_mul(5,5)+mul(32,64](mul(11,8)undo()?mul(8,5))
"""
            },
            "output": "48",
            "ex": None,
