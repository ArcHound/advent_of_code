...
from aoc.year2015.day25 import part1, part2

simple_test = """To continue, please consult the code grid in the manual.  Enter the code at row 3, column 4.
"""
